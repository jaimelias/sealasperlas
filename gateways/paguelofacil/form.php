<div class="sea_checkout_cc hidden">
	...
	<div class="hidden">
		...
		<input name="sea_total" type="number" step="any">
		<input name="sea_description" type="text">	
	</div>
	...
	<p><button id="sea_confirm_checkout" type="button" class="pure-button pure-button-primary width-100 block"><?php echo esc_html(__('Pay Now', 'sealasperlas')); ?></button></p>
